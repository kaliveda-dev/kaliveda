...
Events generated by models & simulations, containing KVSimNucleus nuclei.
...
/**
  ...
  \brief Wrapper class for iterating over groups of nuclei in KVSimEvent accessed through base pointer or reference
  \ingroup NucEvents
  \ingroup Simulation
