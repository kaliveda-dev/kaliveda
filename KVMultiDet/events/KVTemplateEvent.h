...
public:
   ...
   {
      //Initialise KVEvent<Nucleus> to hold mult events of Nucleus objects
      //(default = KVNucleus).
      ...
      fParticles = new TClonesArray(Nucleus::Class(), mult);
   ...
   Nucleus* AddParticle()
   {
      ...
      Int_t mult = GetMult();
#ifdef __WITHOUT_TCA_CONSTRUCTED_AT
      KVNucleus* tmp = (Nucleus*) ConstructedAt(mult, "C");
#else
